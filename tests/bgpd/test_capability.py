...
TestCapability.okfail("BGPsec-recv-v4: BGPsec Receive Capability for IPv4")
TestCapability.okfail("BGPsec-send-v4: BGPsec Send Capability for IPv4")
TestCapability.okfail("BGPsec-recv-v6: BGPsec Receive Capability for IPv6")
TestCapability.okfail("BGPsec-send-v6: BGPsec Send Capability for IPv6")
TestCapability.okfail("BGPsec-invalid-afi: BGPsec invalid AFI")
