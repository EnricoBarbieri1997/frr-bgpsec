...
DEFINE_MTYPE(BGPD, BGP_BGPSEC, "BGP BGPsec");
DEFINE_MTYPE(BGPD, BGP_BGPSEC_PATH, "BGP BGPsec PATH");
DEFINE_MTYPE(BGPD, BGP_BGPSEC_PATH_SS, "BGP BGPsec signature segment");
DEFINE_MTYPE(BGPD, BGP_BGPSEC_SIG, "BGP BGPsec signature");
DEFINE_MTYPE(BGPD, BGP_BGPSEC_SIGBLOCK, "BGP BGPsec signature block");
DEFINE_MTYPE(BGPD, BGP_BGPSEC_PATH_SPS, "BGP BGPsec secure path segment");
DEFINE_MTYPE(BGPD, BGP_BGPSEC_PATH_STR, "BGP BGPsec PATH string");
DEFINE_MTYPE(BGPD, BGP_BGPSEC_NLRI, "BGP BGPsec NLRI");
DEFINE_MTYPE(BGPD, BGP_BGPSEC_PRIV_KEY, "BGP BGPsec private key");

// DEFINE_MTYPE(BGPD, BGP_RPKI_CACHE, "BGP RPKI Cache server");
// DEFINE_MTYPE(BGPD, BGP_RPKI_CACHE_GROUP, "BGP RPKI Cache server group");

DEFINE_MTYPE(BGPD, BGP_RPKI_TEMP, "BGP RPKI Intermediate Buffer");
DEFINE_MTYPE(BGPD, BGP_RPKI_CACHE, "BGP RPKI Cache server");
DEFINE_MTYPE(BGPD, BGP_RPKI_CACHE_GROUP, "BGP RPKI Cache server group");
DEFINE_MTYPE(BGPD, BGP_RPKI_RTRLIB, "BGP RPKI RTRLib");
DEFINE_MTYPE(BGPD, BGP_RPKI_REVALIDATE, "BGP RPKI Revalidation");