...
DECLARE_MTYPE(BGP_BGPSEC);
DECLARE_MTYPE(BGP_BGPSEC_PATH);
DECLARE_MTYPE(BGP_BGPSEC_PATH_SS);
DECLARE_MTYPE(BGP_BGPSEC_SIG);
DECLARE_MTYPE(BGP_BGPSEC_SIGBLOCK);
DECLARE_MTYPE(BGP_BGPSEC_PATH_SPS);
DECLARE_MTYPE(BGP_BGPSEC_PATH_STR);
DECLARE_MTYPE(BGP_BGPSEC_NLRI);
DECLARE_MTYPE(BGP_BGPSEC_PRIV_KEY);

DECLARE_MTYPE(BGP_RPKI_CACHE);
DECLARE_MTYPE(BGP_RPKI_CACHE_GROUP);
